      ...
      <div className="container mx-auto px-4">
        ...
        >
              ...
              <div className="absolute -bottom-6 -right-6 lg:-bottom-8 lg:-right-8">
                {isEditMode && onImageUpload ? (
                  <EditableImage
                    ...
                    isEditable={isEditMode}
                    aspectRatio="1/1"
                    className="w-28 h-28 lg:w-36 lg:h-36 rounded-lg shadow-xl border-4 border-white"
                  />
                ) : smallImage ? (
                  <img
                    src={smallImage}
                    alt={smallImageAlt || ""}
                    className="w-28 h-28 lg:w-36 lg:h-36 object-cover rounded-lg shadow-xl border-4 border-white"
                  />
                ) : null}
              </div>
            )}
          ...
          <div className="w-full lg:w-2/5 flex flex-col gap-5">
            ...
            {/* 裝飾線 */}
            <div
              className="w-16 h-1 rounded-lg mt-2"
              style={{ backgroundColor: colorTheme.accent }}
            />
          </div>
        </div>
